...
import Landscape_Algorithums.TestAlgorithum;
...
public class TestInfinteCubesTerrain extends SimpleApplication {

    private TerrainGrid terrain;
    private boolean usePhysics = true;

    public static void main(final String[] args) {
        Cubes.Test.TestInfinteCubesTerrain app = new Cubes.Test.TestInfinteCubesTerrain();
        app.start();
    }
    ...
    public void simpleInitApp() {
        ...
        blockTerrain.setBlocksFromHeightmap(new Vector3Int(0,0,0), new TestAlgorithum(this.terrain.getHeightMap(), false).setblocks(), CubesTestAssets.BLOCK_GRASS);
    ...
    private final ActionListener actionListener = new ActionListener() {
        ...
        public void onAction(final String name, final boolean keyPressed, final float tpf) {
            if (name.equals("Lefts")) {
                if (keyPressed) {
                    Cubes.Test.TestInfinteCubesTerrain.this.left = true;
                } else {
                    Cubes.Test.TestInfinteCubesTerrain.this.left = false;
                }
            } else if (name.equals("Rights")) {
                if (keyPressed) {
                    Cubes.Test.TestInfinteCubesTerrain.this.right = true;
                } else {
                    Cubes.Test.TestInfinteCubesTerrain.this.right = false;
                }
            } else if (name.equals("Ups")) {
                if (keyPressed) {
                    Cubes.Test.TestInfinteCubesTerrain.this.up = true;
                } else {
                    Cubes.Test.TestInfinteCubesTerrain.this.up = false;
                }
            } else if (name.equals("Downs")) {
                if (keyPressed) {
                    Cubes.Test.TestInfinteCubesTerrain.this.down = true;
                } else {
                    Cubes.Test.TestInfinteCubesTerrain.this.down = false;
                }
            } else if (name.equals("Jumps")) {
                Cubes.Test.TestInfinteCubesTerrain.this.player3.jump();
            }
        }
    };
